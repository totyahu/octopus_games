...
//    g->AddPlayer(8,97,8);
//    g->AddPlayer(9,97,9);
//    g->AddPlayer(10,97,10);
//    g->AddPlayer(11,97,11);
//    g->AddPlayer(12,97,12);
//    g->AddPlayer(13,97,13);
//    g->AddPlayer(14,97,14);
//    g->AddPlayer(15,97,15);
//    g->AddPlayer(16,97,16);
//    g->AddPlayer(17,97,17);
//    g->AddPlayer(18,97,18);
//
//
//
//
...
//    int x = 0;
//
//    g->GetGroupsHighestLevel(1, &Players);
...
////    g->AddPlayer(1723, 143, 0);
////    g->GetHighestLevel(162, &x);
////    g->GetGroupsHighestLevel(2, &Players);
////    g->IncreaseLevel(1308, 1);
//    g->GetAllPlayersByLevel(97, &Players, &x);
//
//    return 0;
//}